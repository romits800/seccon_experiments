...
${SECCON_PATH}/src/solvers/multi_backend/secportfolio-solver --timeout 1000 --gecodeflags "--global-budget 500 --local-limit 50000 $flags" -o $name.out.json --verbose $name.ext.json
