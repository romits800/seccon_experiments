...
gecode-presolver -nogoods false -tabling false -o $name.ext.json --dzn ${file}.dzn  -verbose $name.json
 

${DIVCON_PATH}/src/solvers/multi_backend/portfolio-solver -o $name.out.json --verbose $name.ext.json
