...
$GS --step-aggressiveness 0.1 --global-budget 500 --local-limit 50000 -o $name.gecode.$iter.out.json --verbose $name.ext.json
#${UNISON_PATH}/src/solvers/multi_backend/portfolio-solver --timeout 1200 --gecodeflags "--global-budget 500 --local-limit 50000" -o $name.out.json --verbose $name.ext.json
