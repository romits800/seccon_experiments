...
${SECCON_PATH}/src/solvers/multi_backend/portfolio-solver --timeout 1000 --gecodeflags "--global-budget 500 --local-limit 50000" -o $name.$iter.out.json --verbose $name.ext.json
