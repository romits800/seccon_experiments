...
${DIVCON_PATH}/src/solvers/multi_backend/portfolio-solver --timeout 600 --gecodeflags "--global-budget 300 --local-limit 50000" -o $name.out.json --verbose $name.ext.json
